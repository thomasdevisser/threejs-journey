...
// rectAreaLight.lookAt(new THREE.Vector3()); // A new empty Vector3 spawns at the center
...
// scene.add(spotLight);
// You need to add the target to move the spotlight
...
gui
  ...
  .onChange(() => {
    hemisphereLight.color.set(params.color);
  })
  .name("Sky Color");
gui
